...
impl LsCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if self.all_env_vars {
            payload.insert("all_env_vars".to_string(), Value::Bool(true));
        }

        if let Some(match_spec) = self.match_spec {
            payload.insert("match".to_string(), Value::String(match_spec));
        }
        ...
        if self.self_window {
            payload.insert("self".to_string(), Value::Bool(true));
        }
...
impl SendTextCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        payload.insert("data".to_string(), Value::String(self.data));
        ...
        if self.all {
            payload.insert("all".to_string(), Value::Bool(true));
        }

        if self.exclude_active {
            payload.insert("exclude_active".to_string(), Value::Bool(true));
        }

        if self.bracketed_paste != "disable" {
            payload.insert(
                "bracketed_paste".to_string(),
                Value::String(self.bracketed_paste),
            );
        }
...
impl SendKeyCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        payload.insert("keys".to_string(), Value::String(self.keys));
...
impl Default for CloseWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl CloseWindowCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if self.ignore_no_match {
            payload.insert("ignore_no_match".to_string(), Value::Bool(true));
        }
...
impl Default for ResizeWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ResizeWindowCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        payload.insert(
            "increment".to_string(),
            Value::Number(self.increment.into()),
        );

        if self.axis != "horizontal" {
            payload.insert("axis".to_string(), Value::String(self.axis));
        }
...
impl Default for FocusWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Default for SelectWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Default for NewWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl NewWindowCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if let Some(args) = self.args {
            payload.insert("args".to_string(), Value::String(args));
        }
        ...
        if self.keep_focus {
            payload.insert("keep_focus".to_string(), Value::Bool(true));
        }
        ...
        if self.new_tab {
            payload.insert("new_tab".to_string(), Value::Bool(true));
        }
...
impl Default for DetachWindowCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl DetachWindowCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if self.stay_in_tab {
            payload.insert("stay_in_tab".to_string(), Value::Bool(true));
        }
...
impl SetWindowTitleCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        payload.insert("title".to_string(), Value::String(self.title));
        ...
        if self.temporary {
            payload.insert("temporary".to_string(), Value::Bool(true));
        }
...
impl Default for SetWindowLogoCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl SetWindowLogoCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if let Some(position) = self.position {
            payload.insert("position".to_string(), Value::String(position));
        }
...
impl Default for GetTextCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl GetTextCommand {
    ...
    pub fn build(self) -> Result<KittyMessage, CommandError> {
        ...
        if let Some(extent) = self.extent {
            payload.insert("extent".to_string(), Value::String(extent));
        }

        if self.ansi {
            payload.insert("ansi".to_string(), Value::Bool(true));
        }

        if self.cursor {
            payload.insert("cursor".to_string(), Value::Bool(true));
        }

        if self.wrap_markers {
            payload.insert("wrap_markers".to_string(), Value::Bool(true));
        }

        if self.clear_selection {
            payload.insert("clear_selection".to_string(), Value::Bool(true));
        }
...
impl Default for CreateMarkerCommand {
    fn default() -> Self {
        Self::new()
    }
}
...
impl Default for RemoveMarkerCommand {
    fn default() -> Self {
        Self::new()
    }
}

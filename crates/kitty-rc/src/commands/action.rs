...
impl GotoTabAction {
    pub fn create(tab_num: i32) -> ActionCommand {
...
impl SetTabTitleAction {
    pub fn create(title: impl Into<String>) -> ActionCommand {
...
impl NthWindowAction {
    pub fn create(n: i32) -> ActionCommand {
...
impl ResizeWindowAction {
    pub fn create(shrink: bool) -> ActionCommand {
        if shrink {
...
impl MoveWindowAction {
    pub fn create(direction: impl Into<String>) -> ActionCommand {
...
impl GotoLayoutAction {
    pub fn create(layout: impl Into<String>) -> ActionCommand {
...
impl ScrollToPromptAction {
    pub fn create(direction: i32) -> ActionCommand {
...
impl ScrollToMarkAction {
    pub fn create(marker_type: impl Into<String>) -> ActionCommand {
...
impl SendKeyAction {
    pub fn create(keys: impl Into<String>) -> ActionCommand {
...
impl SendTextAction {
    pub fn create(text: impl Into<String>) -> ActionCommand {
...
impl KittenAction {
    pub fn create(kitten_name: impl Into<String>) -> ActionCommand {
...
impl LaunchAction {
    pub fn create(args: impl Into<String>) -> ActionCommand {
...
impl SignalChildAction {
    pub fn create(signal: impl Into<String>) -> ActionCommand {
...
impl ClearTerminalAction {
    pub fn create(mode: impl Into<String>) -> ActionCommand {
...
impl ShowKittyDocAction {
    pub fn create(topic: impl Into<String>) -> ActionCommand {
...
impl SetBackgroundOpacityAction {
    pub fn create(opacity: f32) -> ActionCommand {
...
impl ChangeFontSizeAction {
    pub fn create(delta: impl Into<String>) -> ActionCommand {
...
impl LoadConfigFileAction {
    pub fn create(path: impl Into<String>) -> ActionCommand {
...
mod tests {
    ...
    #[test]
    fn test_quit_action() {
        let cmd = QuitAction::create().build();
        assert!(cmd.is_ok());
        let msg = cmd.unwrap();
        assert_eq!(msg.cmd, "send_key");
    }
    ...
    fn test_new_tab_action() {
        let cmd = NewTabAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_goto_tab_action() {
        let cmd = GotoTabAction::create(5).build();
        assert!(cmd.is_ok());
        let msg = cmd.unwrap();
        assert!(msg.payload.is_some());
    }
    ...
    fn test_new_window_action() {
        let cmd = NewWindowAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_nth_window_action() {
        let cmd = NthWindowAction::create(3).build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_copy_to_clipboard_action() {
        let cmd = CopyToClipboardAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_paste_action() {
        let cmd = PasteAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_goto_layout_action() {
        let cmd = GotoLayoutAction::create("tall").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_scroll_line_up_action() {
        let cmd = ScrollLineUpAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_create_marker_action() {
        let cmd = CreateMarkerAction::create().build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_send_key_action() {
        let cmd = SendKeyAction::create("ctrl+c").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_send_text_action() {
        let cmd = SendTextAction::create("hello").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_kitten_action() {
        let cmd = KittenAction::create("hints").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_signal_child_action() {
        let cmd = SignalChildAction::create("SIGTERM").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_clear_terminal_action() {
        let cmd = ClearTerminalAction::create("reset").build();
        assert!(cmd.is_ok());
    }

    #[test]
    fn test_set_background_opacity_action() {
        let cmd = SetBackgroundOpacityAction::create(0.8).build();
        assert!(cmd.is_ok());
    }
}
